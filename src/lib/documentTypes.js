export const DOCUMENT_TYPES = {
  ...
  licence: { name: 'Лицензия', abbr: 'LIC', section: 1, hasNumber: true, hasFrom: true, hasTo: true },
  posted_worker_certificate_a1: { name: 'Сертификат A1', abbr: 'A1', section: 1, hasNumber: true, hasFrom: true, hasTo: true, hasA1CHCheckbox: true },
  ...
  chip: { name: 'Чип (тахокарта)', abbr: 'CHIP', section: 2, hasNumber: true, hasFrom: true, hasTo: true },
  code_95: { name: 'Код 95', abbr: 'C95', section: 2, hasNumber: false, hasFrom: true, hasTo: true },
  medical_certificate: { name: 'Медобследование', abbr: 'MED', section: 3, hasNumber: false, hasFrom: true, hasTo: true, autoFillTo: { years: 2 } },
  psycho_test: { name: 'Психотест', abbr: 'PSI', section: 3, hasNumber: false, hasFrom: true, hasTo: true },
